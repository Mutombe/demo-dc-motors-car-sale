    ...
    <section ref={containerRef} className="relative min-h-screen overflow-hidden bg-white">
      ...
      <div className="grid lg:grid-cols-2 min-h-screen">
        <div className="relative overflow-hidden">
          <motion.img src={hero?.backgroundImages?.[0]?.url || 'https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=1400&q=80'} alt="DC Motors Car Sale" className="absolute inset-0 w-full h-full object-cover object-center" style={{ scale: imgScale }} loading="eager" />
        ...
        <motion.div className="flex flex-col justify-center px-8 sm:px-12 lg:px-16 py-24 lg:py-0 pt-36" style={{ y: textY }}>
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.3 }}>
            ...
            <p className="text-blue-600 text-xs font-semibold uppercase tracking-[0.3em] mb-6" style={{ fontFamily: 'var(--font-sans)' }}>Quality Pre-Owned</p>
            <div className="overflow-hidden">
              {['DRIVE', 'CONFIDENT', 'TODAY.'].map((line, i) => (
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              ...
              <a href="tel:+263771844703" className="group inline-flex items-center gap-3 border border-neutral-200 text-neutral-700 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold hover:border-blue-600 hover:text-blue-600 transition-all" style={{ fontFamily: 'var(--font-sans)' }}><Phone size={16} weight="fill" /> Call Us</a>
            </div>
          </motion.div>
        </motion.div>
      </div>
    ...
    <section ref={ref} className="bg-white py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12"><div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9 }}>
          <div className="w-12 h-[2px] bg-blue-600 mb-6" />
          <h2 className="font-heading text-neutral-900 leading-[0.95] font-bold uppercase mb-8" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>About <span className="text-blue-600">DC Motors</span></h2>
          <p className="text-neutral-600 text-sm sm:text-base leading-relaxed mb-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>DC Motors Car Sale on Craster Road delivers expert collision repair and spray painting. Our certified technicians use modern frame straighteners, computerised colour matching, and downdraft spray booths to achieve factory-grade results.</p>
          <div className="flex gap-10"><div><div className="text-blue-600 font-heading text-3xl font-bold">4.8</div><div className="text-neutral-400 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Rating</div></div><div><div className="text-blue-600 font-heading text-3xl font-bold">5</div><div className="text-neutral-400 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Reviews</div></div></div>
        </motion.div>
        <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9, delay: 0.2 }} className="relative">
          <img src="https://images.unsplash.com/photo-1549317661-bd32c8ce0571?w=800&q=80" alt="DC Motors workshop" className="w-full aspect-[4/5] object-cover object-center" loading="lazy" />
  ...
  return (
    <section ref={ref} className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8 }} className="relative z-10 max-w-3xl mx-auto px-5 sm:px-8 text-center">
        ...
        <p className="text-white/50 text-sm sm:text-base max-w-xl mx-auto mb-10" style={{ fontFamily: 'var(--font-sans)' }}>Visit us at Enterprise Rd, Harare for a free assessment.</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a href="https://wa.me/263771844703" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center gap-3 border border-green-500/40 text-green-400 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold hover:bg-green-500/10 transition-all" style={{ fontFamily: 'var(--font-sans)' }}><WhatsappLogo size={18} weight="fill" /> WhatsApp</a>
        </div>
      </motion.div>
    </section>
  );
