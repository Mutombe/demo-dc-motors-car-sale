...
/* ================================================================
   ...
   ================================================================ */
const iconMap = {
  Car, Star, Briefcase, Buildings, Lightbulb, Rocket,
};
    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['DRIVE', 'CLASS', 'DRIVE CONFIDENCE.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
...
function MarqueeTicker() {
  const items = ['SEDANS', 'SUVs', 'TRUCKS', 'IMPORTS', 'FINANCING', 'TRADE-INS'];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  src={hero.backgroundImages?.[0]?.url || 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800&q=80'}
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  src={hero.backgroundImages?.[1]?.url || 'https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=600&q=80'}
    ...
    <section ref={ref} className="bg-navy-900 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              src={siteData.hero.backgroundImages?.[0]?.url || 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800&q=80'}
